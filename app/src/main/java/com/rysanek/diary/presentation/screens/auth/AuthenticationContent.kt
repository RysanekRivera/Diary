...
import com.rysanek.diary.presentation.components.GoogleButton
...
@Composable
fun AuthenticationContentPreviewLoadingStateTrue() {
    AuthenticationContent(loadingState = true, onButtonClicked = {})
}

@Preview(showBackground = true)
@Composable
fun AuthenticationContentPreviewLoadingStateFalse() {
